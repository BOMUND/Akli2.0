...
ECHO_GATE_DB:        Final = 6.0    # +6 dB над фоном = осознанная речь.
                                    # 12 dB было слишком жёстко — голос
                                    # пользователя на тихом микрофоне не
                                    # проходил, перебивание не работало.
