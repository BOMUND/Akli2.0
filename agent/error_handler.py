...
ERROR_ANALYST_PROMPT = """You are the error recovery module of the Akli AI assistant.
...
Return ONLY the Python code, no explanation."""
    ...
    try:
        ...
        # На фолбэке пытаемся выполнить то же действие через dev_agent (единственный оставшийся инструмент для свободного кода).
        return {
            "step":        step.get("step"),
            "tool":        "dev_agent",
